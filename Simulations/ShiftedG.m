...
p1 = plot(delta_G, k_mism, 'ko', 'LineWidth', 1.5, 'MarkerSize', 6, 'DisplayName','Sample Strands with Original NUPACK \Delta G');
p2 = plot(delta_G + offset, k_mism2, 'ro', 'LineWidth', 1.5, 'MarkerSize', 6, 'DisplayName','Sample Strands with -10 Offset \Delta G');
%p3 = plot(delta_G + offset2, k_mism3, 'go', 'LineWidth', 1.5, 'MarkerSize', 6, 'DisplayName','Sample Strands with - 5 Offset \Delta G');
