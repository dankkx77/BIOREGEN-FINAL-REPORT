...
nexttile
histogram(gibbs1,'Normalization', 'probability', 'BinWidth', 0.2, 'FaceColor', 'r');
grid on
title('1 Mismatch (30 strands)')
xlabel('\Delta G (kcal/mole)');
xlim([-15 5]);
ylim([0 0.15]);
...
nexttile
histogram(gibbs2, 'Normalization', 'probability', 'BinWidth', 0.2, 'FaceColor', 'b');
grid on
...
nexttile
histogram(gibbs3,'Normalization', 'probability', 'BinWidth', 0.2, 'FaceColor', 'g');
grid on
...
nexttile
histogram(gibbs1,'Normalization', 'probability', 'BinWidth', 0.2, 'FaceColor', 'r', 'FaceAlpha', 0.5);
hold
histogram(gibbs2, 'Normalization', 'probability', 'BinWidth',0.2, 'FaceColor', 'b', 'FaceAlpha', 0.5);
histogram(gibbs3, 'Normalization', 'probability', 'BinWidth', 0.2, 'FaceColor', 'g', 'FaceAlpha', 0.5);
grid on
