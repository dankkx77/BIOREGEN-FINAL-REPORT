%This file takes in mismatch-specific files for sequences with 1-3 toehold
%mismatches. The files are screened for redundant sequences and
...
%% Read in mismatch-specific files
