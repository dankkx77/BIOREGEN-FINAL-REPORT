...
% Excel Data
data_table = readtable("Full System (k = 1e3 - row1).xlsx", Sheet= 'Analysis', Range = 'H2:BQ111');
...
t_table = readtable("Full System (k = 1e3 - row1).xlsx", Sheet = 'Analysis', Range = 'B2:B111');
